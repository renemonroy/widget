...
This widget version keeps the methods used by the original Widget Class System created by @azendal.
...
Class(Lib, 'Widget').includes(CustomEventSupport, NodeSupport)({
